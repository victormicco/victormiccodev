      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover object-center !m-0 !p-0  rounded-full h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 border-white  relative transition duration-500"
          />
        </div>
      ))}
    </>
